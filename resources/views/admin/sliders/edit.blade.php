        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('page_name') ? 'is-invalid' : '' }}" type="text" name="page_name" id="page_name" value="{{ old('page_name', $slider->page_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('link_text') ? 'is-invalid' : '' }}" type="text" name="link_text" id="link_text" value="{{ old('link_text', $slider->link_text) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('link_url') ? 'is-invalid' : '' }}" type="text" name="link_url" id="link_url" value="{{ old('link_url', $slider->link_url) }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Slider::IS_ACTIVE_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $slider->is_active) === (string) $key ? 'checked' : '' }} required>
