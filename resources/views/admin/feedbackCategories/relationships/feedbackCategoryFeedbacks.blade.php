...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-feedbackCategoryFeedbacks">
                <thead>
                <tr>
                    <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-feedbackCategoryFeedbacks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
