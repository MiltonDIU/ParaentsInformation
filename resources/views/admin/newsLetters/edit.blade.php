        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.news-letters.update", [$newsLetter->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $newsLetter->title) }}" required>
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('external_link') ? 'is-invalid' : '' }}" type="text" name="external_link" id="external_link" value="{{ old('external_link', $newsLetter->external_link) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('external_link_text') ? 'is-invalid' : '' }}" type="text" name="external_link_text" id="external_link_text" value="{{ old('external_link_text', $newsLetter->external_link_text) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content">{!! old('content', $newsLetter->content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\NewsLetter::IS_ACTIVE_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $newsLetter->is_active) === (string) $key ? 'checked' : '' }} required>
